...
from utils.general import check_img_size, check_requirements, check_imshow, colorstr, non_max_suppression, apply_classifier, \
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path, save_one_box, write_det
...
def run(weights='yolov5s.pt',  # model.pt path(s)
        ...
        save_det_img=False,  # Save img only when object found
        max_fps=30  # maximum number of frames per second
        ):
